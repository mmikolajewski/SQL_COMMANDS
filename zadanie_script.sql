...
UPDATE pracownik SET wyplata = (wyplata*1.1) where stanowisko = 'tester';
...
INSERT INTO adres
    (ulica, numer_domu, kod_pocztowy, miejscowosc)
VALUES
...
SELECT
	imie, nazwisko, ulica, numer_domu, kod_pocztowy, miejscowosc, nazwa, wyplata
FROM pracownik
 LEFT JOIN stanowisko on stanowisko_id = stanowisko.id
 LEFT JOIN adres on adres_id = adres.id;
